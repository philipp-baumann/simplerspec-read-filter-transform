...
Requirements prior starting this tutorial
...
2.  Unzip the folder
3.  Double-click the `.RProj` file and the tutorial is loaded as R project (no need to use `set.wd()` other other nasty hard-coded scripts to set the working directory)
