...
spectroscopy reference models. Besides these reference spectra measured witha
...
questions such as spectrometer cross-comparisons. Therefore, other comparison
spectra are in separate paths, e.g.  `data/spectra/soilspec_eth_bin`.
